...
export default function Comparison() {
  return (
    <section id="comparacao" className="py-4 bg-charcoal-black">
      <div className="container mx-auto px-4 flex flex-col items-center text-center">
        <h2 className="text-3xl md:text-4xl font-headline uppercase tracking-wider text-gold mb-8">
          KINDLE X DARKEBOOK
        </h2>
        <div className="relative w-full max-w-2xl mb-8">
          <Image src="https://i.imgur.com/ESwQPel.png" alt="Comparação Kindle vs Darkebook" width={800} height={450} className="rounded-lg shadow-2xl" />
        </div>
        ...
        <Button asChild size="lg" className="bg-gold text-charcoal-black font-bold hover:bg-gold/90 transform hover:scale-105 transition-transform duration-300 w-full sm:w-auto">
          <a href="#ofertas">
