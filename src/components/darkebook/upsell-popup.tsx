      ...
      <div className="bg-card border-2 border-gold rounded-lg shadow-2xl w-full max-w-sm text-center p-6 relative animate-in zoom-in-95">
        ...
        <div className="my-4">
            ...
            <div className='flex flex-col items-center justify-center'>
              <p className="text-lg text-gold">Por apenas</p>
              <p className="text-5xl font-extrabold text-gold -mt-1 tracking-tighter [text-shadow:_2px_2px_4px_rgb(0_0_0_/_50%)]">R$ 15,90</p>
            </div>
        </div>
